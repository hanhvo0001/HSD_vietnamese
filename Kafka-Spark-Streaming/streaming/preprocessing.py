...
""" emoji """
c2e_path = os.path.abspath('../dictionary/character2emoji.xlsx')
...
e2w_path = os.path.abspath('../dictionary/emoji2word.xlsx')
...
""" abbreviation """
adn_path = os.path.abspath('../dictionary/abb_dict_normal.xlsx')
...
ads_path = os.path.abspath('../dictionary/abb_dict_special.xlsx')
